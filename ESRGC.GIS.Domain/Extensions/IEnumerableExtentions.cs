...
namespace ESRGC.GIS.Domain.Extensions
{
    public static class IEnumerableExtentions
    {
        ...
        /// <summary>
        /// Converts an array (list) of dictionary to collection of generic data objects
        /// </summary>
        /// <param name="list">Dictionary type</param>
        /// <returns>IEnumerable type of generic class type</returns>
        public static IEnumerable ToObjectCollection(this IEnumerable<IDictionary> list)
        {
